...
def get_text(file_path)->string:
    ...
    try:
       ...
       tasks_text = extracted_text[choosen_start:choosen_end]
        ...
        print("\033[31m"+"Error : "+file_path+"\033[31m")
    
    return tasks_text

if __name__ == "__main__":
    pass
    # print(get_text("E:\\NLP\\Internship\\Dirty Reports\\Dirty Files\\correct template\\(A) Ahmed Hossam Eldin Ahmed 34-3465 .pdf"))
