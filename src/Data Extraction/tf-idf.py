...
def preprocess_document(document):
    ...
    filtered_words = [stemmer.stem(word) for word in words if
                      word.lower() not in stop_words and not is_number(word) and not is_single_letter(
                          word) and not is_line(word)]
...
if __name__ == "__main__":
    ...
    # return 0
    # print("------------************",stop_words)
    corpus = read_text("C:/Users/legion/Desktop/AI internship/AI-enabled-Reports-Analysis-Software/Final Samples")
